...
async function fetchAll() {
    try {
        ...
        // Find a product that has modifiers
        ...
        console.log("Product Link example:", JSON.stringify(linkedProduct, null, 2));
        console.log("Modifier Group example:", JSON.stringify(modifierGroups[0], null, 2));
        console.log("Modifier example:", JSON.stringify(modifiers[0], null, 2));
